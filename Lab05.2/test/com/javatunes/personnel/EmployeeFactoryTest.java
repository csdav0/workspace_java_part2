...
public class EmployeeFactoryTest {
  ...
  public void init() {
    ...
    invalidMap.put("type", "thisIsInvalid");
    invalidMap.put("name",     "Jackie");
    invalidMap.put("hireDate", "1990-08-24");
    invalidMap.put("salary",   "50000.0");
  }
  ...
  public void testCreateEmployeeSalaried() {
    // TODO
    //arrange
    Employee actualEmployee = EmployeeFactory.createEmployee(seMap);
    //act
    String predictedProperties = "SalariedEmployee: name=Jackie, hireDate=1990-08-24, salary=50000.0";
    //assert
    assertEquals(SalariedEmployee.class, actualEmployee.getClass());
    assertEquals(predictedProperties, actualEmployee.toString());
  }
  ...
  public void testCreateEmployeeHourly() {
    // TODO
    //arrange
    Employee actualEmployee = EmployeeFactory.createEmployee(heMap);
    //act
    String predictedProperties = "HourlyEmployee: name=Jackie, hireDate=1990-08-24, rate=50.0, hours=40.0";
    //assert
    assertEquals(HourlyEmployee.class, actualEmployee.getClass());
    assertEquals(predictedProperties, actualEmployee.toString());
  }
  ...
  public void testCreateEmployeeInvalidTypeThrowsIllegalArgumentException() {
    // TODO
    //arrange//act&//assert
    Employee actualEmployee = EmployeeFactory.createEmployee(invalidMap);
  }
}
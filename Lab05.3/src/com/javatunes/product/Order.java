...
public class Order {
  ...
  public double getTax() {
    taxStrategy = OrderFactory.createTaxStrategy(myTaxReference);
  ...
  public void setMyTaxReference(String myTaxReference) {
    this.myTaxReference = myTaxReference;
  }
}